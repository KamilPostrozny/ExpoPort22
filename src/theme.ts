...
/** A role at partial alpha, for the few places that tint rather than fill — a glass edge, a pressed
 *  key over a blur. Prefer a role outright: alpha over an unknown backdrop is how a light theme ends
 *  up with an invisible hairline. */
