...
> **HISTORICAL — NOT THE ACTIVE BUG LIST.** See [current triage](../issues.md).
> OPEN/FIXED labels and platform evidence below are dated observations, not current checkout
> verification. Removed ribbon issues are retired. Read a named investigation only; do not
> execute old harness recipes or treat proposed fixes as instructions.
